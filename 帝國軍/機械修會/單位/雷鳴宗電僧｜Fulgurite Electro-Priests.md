...
**雷電護體。** 有人物領導本單位時，對本單位的攻擊造傷結果減 1。

## 武器

| 武器 | 射程 | A | BS／WS | S | AP | D | 能力 |
|---|---:|---:|---:|---:|---:|---:|---|
| 吸能禪杖 | 近戰 | 2 | 3+ | 6 | -1 | 2 | 毀滅傷害 |

## 編制、點數與裝備

| 項目 | 內容 |
|---|---|
| 編制 | 5 個雷鳴宗電僧；可增加 5 個相同模型。 |
| 點數 | 70／140 分 |
| 裝備 | 吸能禪杖。 |
| 升級選項 | 無。 |
| 版本註記 | MFM v1.2：5／10 模型為 70／140 分；點數依官方 Munitorum Field Manual v1.2。 |

## 關鍵字

**關鍵字：** 步兵、帝國、機械教、電僧、雷鳴宗。
