---
title: 西多尼安龍騎兵（輻射長管槍）
canonical_name: Sydonian Dragoons with Radium Jezzails
faction: 機械修會
...
**專注獵手。** 遊戲開始時，在對手軍隊中選擇一個單位；本場遊戲中本單位攻擊該敵方單位時可重擲命中結果。
...
| 輻射長管槍 | 36 | 1 | 4+ | 5 | -2 | 3 | 反步兵 3+、重型、精準 |
| 鐵足踐踏 | 近戰 | 3 | 4+ | 5 | 0 | 1 | 無 |
...
| 項目 | 內容 |
|---|---|
| 編制 | 1 個西多尼安龍騎兵；最多增加 2 個相同模型。 |
| 點數 | 55／100／150 分 |
| 裝備 | 磷火短銃、輻射長管槍、鐵足踐踏。 |
| 升級選項 | 第二、第三個模型的 MFM 點數分別為 45／50 分。 |
| 版本註記 | 點數依官方 Munitorum Field Manual v1.2。 |

## 關鍵字

**關鍵字：** 載具、機甲、煙霧彈、帝國、護教軍、西多尼安、龍騎兵。
