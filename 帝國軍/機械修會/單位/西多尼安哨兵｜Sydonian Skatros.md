---
title: 西多尼安哨兵
canonical_name: Sydonian Skatros
faction: 機械修會
...
**核心：獨行特工、隱蔽。** 本模型擁有獨行特工與隱蔽。

**無情狙擊。** 在你的射擊階段，本模型射擊完成後，選擇本階段它命中的一個敵方單位；該敵方單位必須進行被震懾測試。

**分析弱點。** 使用輻射長管槍攻擊步兵時可重擲造傷；使用超鈾元素步槍攻擊巨獸或載具時可重擲造傷。
...
| 輻射長管槍 | 36 | 1 | 3+ | 5 | -2 | 3 | 反步兵 3+、重型、精準 |
| 超鈾元素步槍 | 36 | 1 | 3+ | 7 | -2 | D3 | 反巨獸 4+、反載具 4+、重型、精準 |
| 鐵腿踐踏 | 近戰 | 3 | 4+ | 3 | 0 | 1 | 無 |
