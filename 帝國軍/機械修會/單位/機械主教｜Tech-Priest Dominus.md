---
title: 機械主教
canonical_name: Tech-Priest Dominus
faction: 機械修會
...
**機械教主宰。** 本模型所領導單位中的模型獲得不知疼痛 5+；若該單位擁有電僧關鍵字，則改為不知疼痛 4+。

**數據探針。** 近戰階段開始時，選擇本模型接戰範圍內一個敵方載具並擲 D6；4+ 時該載具受到 D6 點致命傷害，且本階段其近戰武器武器技能減 1。

## 武器

| 武器 | 射程 | A | BS／WS | S | AP | D | 能力 |
|---|---:|---:|---:|---:|---:|---:|---|
| 絕滅射線：分散 | 24 | D3 | 3+ | 6 | -1 | 1 | 無 |
| 絕滅射線：聚焦 | 12 | D3 | 3+ | 6 | -2 | 2 | 無 |
| 微型衝鋒槍 | 12 | 5 | 3+ | 4 | 0 | 1 | 手槍 |
| 磷火轉輪槍 | 18 | 1 | 3+ | 5 | -1 | 2 | 忽視掩體、手槍 |
| 爆燃爆破槍 | 24 | 3 | 3+ | 5 | 0 | 1 | 毀滅傷害 |
| 機神戰斧 | 近戰 | 4 | 3+ | 6 | -2 | 2 | 無 |
...
| 點數 | 65 分 |
| 裝備 | 微型衝鋒槍、爆燃爆破槍、機神戰斧。 |
| 升級選項 | 微型衝鋒槍可換為磷火轉輪槍；爆燃爆破槍可換為絕滅射線。 |
| 版本註記 | 點數依官方 Munitorum Field Manual v1.2。 |

## 關鍵字

**關鍵字：** 步兵、人物、帝國、機械教、技術牧師、機械主教。
