...
**靈活機動。** 本單位即使同回合撤退或加速，仍可射擊；本單位模型可重投絕望撤退測試。
...
|---|---:|---:|---:|---:|---:|---:|---|
| 雙聯智能自動炮 | 48 | 4 | 4+ | 9 | -1 | 3 | 連擊 1、雙聯 |
| 雙聯智能雷射炮 | 48 | 2 | 4+ | 12 | -3 | D6+1 | 連擊 1、雙聯 |
| 鐵足踐踏 | 近戰 | 3 | 4+ | 5 | 0 | 1 | 無 |
...
| 項目 | 內容 |
|---|---|
| 編制 | 1 個巴利斯塔利鐵騎兵；最多增加 2 個模型。 |
| 點數 | 80／160／250 分；第三個以上 95／175／265 分 |
| 裝備 | 雙聯智能自動炮、鐵足踐踏。 |
| 升級選項 | 任意模型可將雙聯智能自動炮換為雙聯智能雷射炮，每個模型 +10 分。 |
| 版本註記 | MFM v1.2：前兩個單位 1／2／3 模型為 80／160／250 分；第三個以上為 95／175／265 分；點數依官方 Munitorum Field Manual v1.2。 |

## 關鍵字

**關鍵字：** 載具、機甲、煙霧彈、帝國、護教軍、巴利斯塔利鐵騎兵。
